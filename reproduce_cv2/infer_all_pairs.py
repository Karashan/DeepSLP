...
DEF_KO = os.path.join(REPO, "data/input/AE_3L/AE128_std100_CRISPRGeneEffect_24Q4_imputed_gene_wise_mean_align_qGI2021.txt")
DEF_EXP = os.path.join(REPO, "data/input/AE_3L/AE128_std100_Expression_BC_24Q4_align_qGI2021.txt")
